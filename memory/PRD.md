...
P2 — copy refresh (DONE 2026-09-25, per user: positioning is audiobook distribution from authors globally, not a studio); hero rebuilt as Product-Behind-Text layering (DONE 2026-09-25, per user's Auramax reference: giant BOOKLAB wordmark behind a transparent-cutout headset, details pinned to bottom edges, wave strip intact)
